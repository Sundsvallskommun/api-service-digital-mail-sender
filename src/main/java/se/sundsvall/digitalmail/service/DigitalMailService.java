...
public class DigitalMailService {
    ...
    DigitalMailService(final CitizenClient citizenClient,
    ...
    public DigitalMailResponse sendDigitalMail(final DigitalMailDto requestDto) {
        final var personalNumber = citizenClient.getPersonNumber(requestDto.getPartyId());
    ...
    public DigitalInvoiceResponse sendDigitalInvoice(final InvoiceDto invoiceDto) {
        final var ssn = citizenClient.getPersonNumber(invoiceDto.getPartyId());
    ...
    public boolean verifyRecipientHasSomeAvailableMailbox(final String partyId) {
        try {
            final var personalNumber = citizenClient.getPersonNumber(partyId);
