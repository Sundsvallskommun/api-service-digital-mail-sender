...
public record DigitalInvoiceRequest(
        ...
        @ValidUuid
        @Schema(description = "partyId for the person or organization the invoice should be sent to", example = "6a5c3d04-412d-11ec-973a-0242ac130003", requiredMode = REQUIRED)
        String partyId,
        ...
        @NotBlank
        @Schema(description = "The invoice subject", example = "Faktura från Sundsvalls kommun", requiredMode = REQUIRED)
        String subject,
